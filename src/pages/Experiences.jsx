  ...
  return (
    <div className="flex flex-col justify-center bg-[#BFCFE7]">
      ...
      <div className="flex flex-col flex-1">
        <div className="max-w-7xl mx-auto xl:mx-[320px] md:w-full grid grid-cols-6 lg:grid-cols-5 lg:relative bottom-20 right-14 pb-4">
              ...
              <p className="text-gray-500 sm:text-sm text-xs">
                <ul className="list-disc ml-4">
                  <li>
                    ...
                    Sustainability Office to promote bird-friendly initiatives
                    on campus
                  </li>
                  <li>
          ...
          >
            <div className="w-full h-full bg-[#F8EDFF] rounded-md p-2 md:pl-4">
              ...
              <p className="text-gray-500 sm:text-sm text-xs">
                <ul className="list-disc ml-4">
                  <li>
                    2-month training in the employability and life skills
                    program
                  </li>
                  <li>
            ...
            <div className="w-full h-full bg-[#F8EDFF] rounded-md p-2 md:pl-4">
              ...
              <p className="text-gray-500 sm:text-sm text-xs">
                <ul className="list-disc ml-4">
                  ...
                  <li>
                    analyzed customer needs and recommended appropriate foods
              ...
              <p className="text-gray-500 sm:text-sm text-xs">
                <ul className="list-disc ml-4">
                  <li>
                    ...
                    individuals per day at the hospital entrance and ensured
                    they were free from COVID-19
                  </li>
                  <li>
                  ...
                  <li>
                    Identified and reported ongoing client concerns,
                    recommending strategies to improve the service experience
                  </li>
                </ul>
              </p>
            </div>
